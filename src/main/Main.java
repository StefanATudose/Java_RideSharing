...
public class Main {
    public static void main(String[] args) {
        ...
        AppService.popularePentruTestare(admin);
        ...
        while(true){
            ...
            if (optiune == 1){
                ...
                if (op2 == 1){
                    ...
                    AppService.addTipCupon(admin);
                }
                else if (op2 == 5) {
                    AppService.addCard(admin);
                }
            }
            else if(optiune == 2){
                ...
                if (op2 == 1){
                    ...
                    AppService.showCupoane(admin);
                }
                else if (op2 == 5) {
                    AppService.showCarduri(admin);
                }
            }
            else if(optiune == 3){
                    AppService.acordaCupoane(admin);
            }
            else if(optiune == 4){
